"""
Recipe Knowledge Graph - JSON API Module
=========================================
Transforms SPARQL query results into JSON format for API consumption.

This module provides a clean interface between the RDF knowledge graph
and any frontend application (web, mobile, or other services).
"""
...
def load_graph(file_path: str = None) -> Graph:
    ...
    if file_path is None:
        # Try to find the knowledge graph file
...
def get_statistics() -> Dict[str, Any]:
    ...
    Returns:
        JSON-compatible dict with all statistics
    """
    load_graph()
...
def get_all_recipes(limit: int = 100, offset: int = 0) -> Dict[str, Any]:
    ...
    Returns:
        JSON-compatible dict with recipes list and metadata
    """
    load_graph()
...
def get_recipe_by_id(recipe_id: str) -> Dict[str, Any]:
    ...
    Args:
        recipe_id: The recipe ID (e.g., "632983" or full URI)
    
    Returns:
        JSON-compatible dict with full recipe details
    """
    load_graph()
...
def search_recipes(
    ...
    Args:
        ingredient: Filter by ingredient name (partial match)
        diet: Filter by diet type
        cuisine: Filter by cuisine type
        max_time: Maximum cooking time in minutes
        has_video: Only return recipes with video tutorials
        limit: Maximum results to return
    
    Returns:
        JSON-compatible dict with matching recipes
    """
    load_graph()
...
def get_recipes_with_videos(limit: int = 100) -> Dict[str, Any]:
    """
    Get all recipes that have YouTube video tutorials.
    
    Returns:
        JSON-compatible dict with recipes that have videos
    """
    load_graph()
...
def get_all_ingredients(limit: int = 500) -> Dict[str, Any]:
    ...
    Returns:
        JSON-compatible dict with ingredients list
    """
    load_graph()
...
def get_ingredient_by_id(ingredient_id: str) -> Dict[str, Any]:
    ...
    Args:
        ingredient_id: The ingredient ID or name
    
    Returns:
        JSON-compatible dict with ingredient details and recipes using it
    """
    load_graph()
...
def get_external_links() -> Dict[str, Any]:
    """
    Get all external knowledge base links (DBpedia, Wikidata, FoodOn).
    
    Returns:
        JSON-compatible dict with all external links organized by KB
    """
    load_graph()
...
def get_all_diets() -> Dict[str, Any]:
    """
    Get all diet types with recipe counts.
    
    Returns:
        JSON-compatible dict with diet types
    """
    load_graph()
...
def get_all_cuisines() -> Dict[str, Any]:
    """
    Get all cuisine types with recipe counts.
    
    Returns:
        JSON-compatible dict with cuisine types
    """
    load_graph()
...
def execute_sparql(query: str) -> Dict[str, Any]:
    """
    Execute a custom SPARQL query and return results as JSON.
    
    Args:
        query: SPARQL query string
    
    Returns:
        JSON-compatible dict with query results
    """
    load_graph()
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("RECIPE KNOWLEDGE GRAPH - JSON API")
    print("=" * 70)

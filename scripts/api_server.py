"""
Recipe Knowledge Graph - REST API Server
=========================================
FastAPI server providing REST endpoints for the recipe knowledge graph.
...
async def get_statistics():
    ...
    Returns counts for recipes, ingredients, videos, and external links.
    """
...
async def get_recipe(recipe_id: str):
    ...
    Includes ingredients, nutrition, diets, cuisines, instructions, and video.
    """
...
async def search_recipes(
    ...
    Examples:
    - /api/search?ingredient=chicken
    - /api/search?diet=vegan&max_time=30
    - /api/search?has_video=true
    """
...
async def get_ingredients(
    ...
    """
    Get all ingredients with external KB links.
    """
...
async def get_ingredient(ingredient_id: str):
    ...
    Includes external links and recipes using this ingredient.
    """
...
async def get_external_links():
    """
    Get all external knowledge base links.
    
    Returns links to DBpedia, Wikidata, and FoodOn.
    """
